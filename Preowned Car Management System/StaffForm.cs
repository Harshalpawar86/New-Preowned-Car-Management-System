...
namespace Preowned_Car_Management_System
{
    public partial class StaffForm : Form
    {
        ...
        public void AddStaffInfoFun(String staffName, String staffBOD, String staffGender, int staffMobileNumber, String staffEmail, String staffAddress, String jobDesignation)
        {
            ...
            StaffGenderLabel.Location = new Point(12, StaffNameLabel.Bottom + 2); // Reduced the gap
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlDataAdapter adapter = new SqlDataAdapter(query, conn))
                    {
...

                        {
                            ...
                            AddStaffInfoFun(staffName: staffName, staffBOD: staffDOB, staffGender: staffGender, staffMobileNumber: staffNumber, staffEmail: staffMail, staffAddress: staffAddress, jobDesignation: staffJob); 
                            }
                        }
                }
            ...
            try
            {
                ...
                if (addStaffInfoForm.ShowDialog() == DialogResult.OK)
                {
                   ...
                   String StaffGender  = addStaffInfoForm.staffGender;
                    ...
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        string query = "INSERT INTO StaffTable (StaffName, StaffGender, StaffDOB, StaffNumber, StaffMail,StaffAddress,StaffJob) " +
                                       "VALUES (@StaffName, @StaffGender, @StaffDOB, @StaffNumber, @StaffMail,@StaffAddress,@StaffJob)";
